...
const SPACE_KEYWORDS =
  /rocket|propuls|propellant|thruster|turbopump|nozzle|combust|launch vehicle|hypersonic|scramjet|ablat|spacecraft|satellit|\borbit|lunar|\bmars\b|asteroid|comet|nebula|exoplanet|space station|space debris|reentry|entry descent|astronaut|microgravity|deep space|space mission|space explor|cosmic|\buniverse\b|\bcosmos\b|galax|stellar|\bstar\b|\bstars\b|astronom|astrophys|black hole|supernova|telescope|dark matter|dark energy|gravitational wave|quasar|pulsar|accretion|interstellar|white dwarf|neutron star|redshift|\biss\b|\bnasa\b|\besa\b|thrust vector|thrust.{0,4}control|thrust.{0,4}magnitude|regenerative cooling|injector design|aerothermodynamic|thermal protection system|flight dynamics|guidance.{0,3}navigation|powered descent|orbital mechanics|orbit determination|delta-v|specific impulse|\bisp\b|low-thrust trajectory/i;
